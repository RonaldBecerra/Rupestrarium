...
function getDescription(){
	...
	document.getElementById("desc").innerHTML = 
		`<p style='position:absolute;top:0px; left:-37px; margin: auto;text-align: center;font-family: "FontTexto";font-size: 2.5vh;text-align: center;font-weight:600;width:35em;color:` + color +`;'>`+ object.description + `</p>`

		+ `<p style='position:absolute; bottom:0px; left:-48px;margin: auto;text-align: center; font-family: "FontSub";font-size: 3vh;font-weight:600;width:30em;color:` + color +`;'>` + object.kind + `</p>`;
}
